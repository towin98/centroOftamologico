                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group position-relative">
                                        <label for="email">Número de documento / E-mail<span
                                                class="text-danger">*</span></label>
                                        <i class="fas fa-user ml-3 icons"></i>
                                        <input type="text"
                                            class="form-control pl-5 @error('email') is-invalid @enderror @error('documentNumber') is-invalid @enderror"
                                            name="email" id="email" required
                                            value="{{ old('documentNumber') ?: old('email') }}" autocomplete="email">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group position-relative">
                                        ...
                                        <div class="input-group">
                                            <input type="password"
                                                class="form-control password pl-5 @error('password') is-invalid @enderror"
                                ...
                                <div class="col-12 text-center">
                                    <p class="mb-0 mt-3"><small class="text-dark mr-2">¿Aún no estás registrado(a)?</small>
                                        <a href="{{ route('register') }}" class="text-dark font-weight-bold">¡Regístrate
                                            ahora!</a>
                                    </p>
