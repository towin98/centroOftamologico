            ...
            <div class="col-lg-7 col-md-7">
                <div class="card mt-2 rounded">
                    <div class="card-header text-center bg-light rounded">
                        <h5>Crea una cuenta en el centro oftalmológico surcolombiano ltda Neiva. </h5>
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('registroForm') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        ...
                                        <select name="tipo" id="tipo"
                                            class="form-control pl-5 @error('tipo') is-invalid @enderror" required>

                                            <option value="">Seleccione</option>
                                            <option value="CC" @if (old('tipo')) selected
                                                @endif>CC - Cédula de ciudadanía
                                            </option>
                                            <option value="CE" @if (old('tipo')) selected
                                                @endif>CE - Tarjeta de Identidad
                                            </option>
                                            <option value="RC" @if (old('tipo')) selected
                                                @endif>RC - Registro civil
                                            </option>
                                        </select>
                                        @error('tipo')
                                ...
                                <div class="col-sm-6 col-lg-6">
                                    <div class="form-group position-relative">
                                        ...
                                        <select id="tipo_sangre" name="tipo_sangre"
                                            class="form-control pl-5 @error('tipo_sangre') is-invalid @enderror" required>
                                            <option value="">Seleccione</option>
                                ...
                                <div class="col-sm-6 col-lg-6">
                                    <div class="form-group position-relative">
                                        ...
                                        <select id="tipo_eps" name="tipo_eps"
                                            class="form-control pl-5 @error('tipo_eps') is-invalid @enderror" required>
                                            <option value="">Seleccione</option>
                                                ...
                                                @foreach ($eps as $epsValue)
                                                    @if ($epsValue->id_tipo_eps == 1)
                                                        <option value="{{ $epsValue->id }}"
                                                            {{ old('tipo_eps') == $epsValue->id ? 'selected' : '' }}>
                                                            {{ $epsValue->nombre }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="form-group position-relative">
                                        ...
                                        --}}
                                        <input type="password"
                                            class="form-control password @error('passwordNew') is-invalid @enderror"
                                            name="passwordNew" id="passwordNew" value="{{ old('passwordNew') }}" required
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="passwordConfirm">{{ __('Confirmar Contraseña') }}<span
