...
@section('content')
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="medico" id="medico_id" required>
                                        ...
                                        {{-- @foreach ($medicos as $medico)
                                            <option value="{{ $medico->id }}">{{ $medico->name . ' ' . $medico->lastname }}
                                            </option>
                                        @endforeach --}}
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <button data-toggle="modal" class="btn btn-link" data-target="#ModalOrden"
                                        id="verDocumento">ver Documento</button>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" data-duracion="" class="form-control" name="end" id="end">
    ...
    <!-- Modal -->
    <div class="modal fade bd-example-modal-xl" id="ModalOrden" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="ModalOrdenLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalOrdenLabel">Orden</h5>
